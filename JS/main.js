//https://api.themoviedb.org/3/search/movie?api_key=b6df159d121dc79c541bc18dc1eb06c8&query=${search}
//https://api.themoviedb.org/3/discover/movie?api_key=b6df159d121dc79c541bc18dc1eb06c8
...
async function getMovie(){
    ...
    let movie = await fetch('https://api.themoviedb.org/3/discover/movie?api_key=b6df159d121dc79c541bc18dc1eb06c8', options)
...
function displayDataMovie(data){
    ...
    for(let i=0;i<data.length;i++){
        ...
        <div class="caption p-4 text-light">
            <h2>${data[i].title}</h2>
            <p class="rotating-paragraph">${data[i].overview}</p>
...
function displaySearchData(data){
    ...
    for(let i=0;i<data.length;i++){
        ...
        <div class="caption p-4 text-light">
            ...
            <h3 data-id="${data[i].vote_average}" id="${id}">${data[i].vote_average}</h3>
        </div>
    </div>`
    }
...
$('#error-rep').on('input', function() {
    ...
    /*
                ...
                <i class="fa-solid fa-star-half-stroke half1"></i>
                <i class="fa-solid fa-star star2"></i>
                <i class="fa-solid fa-star-half-stroke half2"></i>
                <i class="fa-solid fa-star star3"></i>
                <i class="fa-solid fa-star-half-stroke half3"></i>
                <i class="fa-solid fa-star star4"></i>
                <i class="fa-solid fa-star-half-stroke half4"></i>
                <i class="fa-solid fa-star star5"></i>
                <i class="fa-solid fa-star star-inactive" style="color: gray;"></i>
    */
   /*$("h3").foreach(function() {
        ...
        if (dataId) {
            // Perform a condition based on the data-id value
            if (dataId <= 0) {
                $('.rate').append('<i class="fa-solid fa-star star-inactive" style="color: gray;"></i>');
            } 
            else if(dataId > 0 && dataId < 2){
                $('.rate').append('<i class="fa-solid fa-star-half-stroke half1"></i>');
            }
            else if(dataId >= 2 && dataId < 3){
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
            }
            else if(dataId >= 3 && dataId < 4){
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star-half-stroke half1"></i>');
            }
            else if(dataId >= 4 && dataId < 5){
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
            }
            else if(dataId >= 5 && dataId < 6){
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star-half-stroke half1"></i>');
            }
            else if(dataId >= 6 && dataId < 7){
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
            }
            else if(dataId >= 7 && dataId < 8){
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star-half-stroke half1"></i>');
            }
            else if(dataId >= 8 && dataId < 9){
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
                $('.rate').append('<i class="fa-solid fa-star star1"></i>');
            ...
            console.log('No data-id attribute found for this element.');
        }
    });
    */
